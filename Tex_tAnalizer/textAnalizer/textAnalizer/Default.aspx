...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div style="margin-left:3%; text-align:center " class="jumbotron">
        <h1>Welcome to text analizer</h1>
            
        <div class="row">
             <asp:RadioButton id="rd_secuencial" style="margin-left:26%; " class="col-md-4" Text="Secuencial" Checked="True" GroupName="RadioGroup1" runat="server" /><br />
        ...
        <div  style="">
                  ...
                  <asp:ListItem Value=0> Desencriptar </asp:ListItem>
    ...
    <div style="height:40%; margin-top:10%;" class="row">
        ...
        <asp:LinkButton id="linkClean" style="margin-left:16.5%;" runat="server" Text="<span class='glyphicon glyphicon-erase'></span> Limpiar" OnClick="cleanData_Click" CssClass="btn btn-primary"/>
        <asp:LinkButton id="linkConsultar" style="margin-left:23%;" runat="server" Text="<span class='glyphicon glyphicon-search'></span> Consultar" OnClick="startProcess_Click" CssClass="btn btn-primary"/>
